...
import com.example.raul.circuito.fragments.frgPublicadorNoActualizado;
...
public class TabbedIngresoActivity extends AppCompatActivity implements
        ...
        frgIngresoNuevoPublicador.OnFragmentInteractionListener,
        frgPublicadorNoActualizado.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabbed_ingreso);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tabbed_ingreso, menu);
        return true;
    }
...
/*        public static PlaceholderFragment newInstance(int sectionNumber) {
        ...
        public static Fragment newInstance(int sectionNumber) {
            ...
            switch (sectionNumber){
                case 1:fragment=new frgIngresoCongregaciones();
                    break;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_tabbed_ingreso, container, false);
            return rootView;
        }
    }
