 ...
 * {@link frgConsNoEstudios.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link frgConsNoEstudios#newInstance} factory method to
 * create an instance of this fragment.
 */
public class frgConsNoEstudios extends Fragment {
    ...
    RecyclerView recyclerConsNoEstudios;
    ArrayList<String> listaNoEstudios;

    public frgConsNoEstudios() {
     ...
     * @return A new instance of fragment frgConsNoEstudios.
     */
    // TODO: Rename and change types and number of parameters
    public static frgConsNoEstudios newInstance(String param1, String param2) {
        frgConsNoEstudios fragment = new frgConsNoEstudios();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerConsNoEstudios.setLayoutManager(new LinearLayoutManager(getContext()));

        llenarlista();

        AdapterDatosNoRevEst adapter = new AdapterDatosNoRevEst(listaNoEstudios);
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                globalClass.setNombrePublicador(listaNoEstudios.get(recyclerConsNoEstudios.getChildAdapterPosition(v)));
        ...
        recyclerConsNoEstudios.setAdapter(adapter);
...
//                "AND tbl_ACTIVIDAD.AñoMes BETWEEN " + globalClass.getFechaA() + " AND " + globalClass.getFechaB() +")");
        ...
        Cursor cursor = builder.query(db, sqlSelect, "tbl_CONGREGACIONES.ID_Congregacion = ? and tbl_ACTIVIDAD.AñoMes between " +
                "? and ?", argumentos, "tbl_PUBLICADORES.Nombre", "tbl_ACTIVIDAD.Estudios = 0", "tbl_PUBLICADORES.Nombre ASC");

        while (cursor.moveToNext()){
            listaNoEstudios.add(cursor.getString(0));
        }
