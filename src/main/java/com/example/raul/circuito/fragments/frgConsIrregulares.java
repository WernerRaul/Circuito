...
import com.example.raul.circuito.Adapters.AdapterDatosIrregulares;
 ...
 * {@link frgConsIrregulares.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link frgConsIrregulares#newInstance} factory method to
 * create an instance of this fragment.
 */
public class frgConsIrregulares extends Fragment {
    ...
    RecyclerView recyclerConsIrregulares;
    ArrayList<IrregularVo> listaIrregulares;


    public frgConsIrregulares() {
     ...
     * @return A new instance of fragment frgConsIrregulares.
     */
    // TODO: Rename and change types and number of parameters
    public static frgConsIrregulares newInstance(String param1, String param2) {
        frgConsIrregulares fragment = new frgConsIrregulares();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_frg_cons_irregulares, container, false);

        listaIrregulares = new ArrayList<>();

        recyclerConsIrregulares = vista.findViewById(R.id.RecyclerConsIrregulares);
        recyclerConsIrregulares.setLayoutManager(new LinearLayoutManager(getContext()));

        llenarlista();

        AdapterDatosIrregulares adapter = new AdapterDatosIrregulares(listaIrregulares);
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                globalClass.setNombrePublicador(listaIrregulares.get(recyclerConsIrregulares.getChildAdapterPosition(v)).getNombre());
        ...
        recyclerConsIrregulares.setAdapter(adapter);
...
//                "AND (tbl_ACTIVIDAD.AñoMes BETWEEN " + globalClass.getFechaA() + " AND " + globalClass.getFechaB() +
        ...
        Cursor cursor = builder.query(db, sqlSelect, "tbl_CONGREGACIONES.ID_Congregacion = ? and tbl_ACTIVIDAD.AñoMes between " +
                "? and ?", argumentos, null, null, "tbl_PUBLICADORES.Nombre ASC");

        while (cursor.moveToNext()) {
            IrregularVo irregularVo = new IrregularVo();
            irregularVo.setNombre(cursor.getString(0));
            irregularVo.setAnomes(cursor.getString(1));

            listaIrregulares.add(irregularVo);
        }
